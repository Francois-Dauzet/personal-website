...
export const skillsData = [
  {
    ...
    tools: [
      { name: 'React.js', background: '#087A9F', color: '#ffffff', value: 75 },
      {
        name: 'Javascript',
        background: '#EFD81D',
        color: '#000814',
      ...
      { name: 'HTML', background: '#DD4B25', color: '#000814', value: 95 },
      { name: 'CSS', background: '#254BDD', color: '#ffffff', value: 95 },
      { name: 'JQuery', background: '#0865A7', color: '#ffffff', value: 60 },
      { name: 'Symfony', background: '#19161A', color: '#ffffff', value: 35 },
      { name: 'Vue.js', background: '#3FB27F', color: '#000814', value: 30 },
      { name: 'Twig', background: '#BFD52A', color: '#000814', value: 40 },
      { name: 'Wordpress', background: '#30353A', color: '#ffffff', value: 15 },
    ],
  },
  {
    ...
    tools: [
      { name: 'MariaDB', background: '#BA7257', color: '#000814', value: 35 },
      { name: 'C#', background: '#7255D5', color: '#ffffff', value: 40 },
      { name: 'FastAPI', background: '#059487', color: '#000814', value: 20 },
      { name: 'Python', background: '#3D6CA6', color: '#ffffff', value: 25 },
      { name: 'Laravel', background: '#F72C1F', color: '#000814', value: 65 },
      { name: 'Symfony', background: '#19161A', color: '#ffffff', value: 45 },
      { name: 'PHP', background: '#7377AD', color: '#000814', value: 60 },
      { name: 'SQL', background: '#0172B8', color: '#ffffff', value: 70 },
    ],
  },
  {
    icon: iconMobilePath,
    ...
    tools: [
      ...
      { name: 'Xcode', background: '#19ADEE', color: '#000814', value: 40 },
    ],
  },
  {
    icon: iconDevopsPath,
    ...
    tools: [
      ...
      { name: 'Vagrant', background: '#127EFF', color: '#000814', value: 35 },
      { name: 'Bash', background: '#1B1B1F', color: '#ffffff', value: 45 },
      { name: 'Docker', background: '#0091E2', color: '#000814', value: 45 },
      { name: 'Git', background: '#DD4C35', color: '#000814', value: 65 },
      {
        name: 'Linux Sysadmin',
        background: '#FED21F',
        color: '#000814',
  ...
  },
  {
    ...
    tools: [
      { name: 'Coolors', background: '#08A3FD', color: '#000814', value: 85 },
      { name: 'DrawSQL', background: '#232323', color: '#ffffff', value: 65 },
      {
        name: 'Excalidraw',
        background: '#6965DB',
        color: '#ffffff',
      ...
      { name: 'Figma', background: '#F25425', color: '#000814', value: 35 },
      {
        name: 'Framindmap',
        background: '#725794',
        color: '#ffffff',
      ...
      { name: 'Prezi', background: '#3685FF', color: '#000814', value: 65 },
      { name: 'Trello', background: '#087DC1', color: '#000814', value: 60 },
    ],
  },
  {
    icon: iconToolsPath,
    ...
    tools: [
      ...
      { name: 'Firebase', background: '#FFCB2C', color: '#000814', value: 35 },
      ...
      { name: 'FileZilla', background: '#B50000', color: '#ffffff', value: 70 },
      { name: 'Laragon', background: '#33A7FD', color: '#000814', value: 80 },
      { name: 'Linux', background: '#FED21F', color: '#000814', value: 55 },
      { name: 'macOS', background: '#4E4E4E', color: '#ffffff', value: 65 },
      { name: 'Notepad++', background: '#AAF37F', color: '#000814', value: 50 },
      {
